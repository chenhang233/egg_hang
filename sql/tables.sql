...
INSERT INTO `adminuser` VALUES (20,'13kl12cd210hi311ij522tu62cd%21st%','admin','12356',NULL,0,NULL),(23,'23uv117op215mn320rs59jh613kl%25wx%','test','12356',NULL,1,NULL);
...
INSERT INTO `adminuserinfo` VALUES (20,'13kl12cd210hi311ij522tu62cd%21st%','123','男',NULL,NULL,NULL,'2022-08-01 09:47:14.000000','C:\\Users\\赵海涛\\Desktop\\egg_hang\\app\\uploads\\1659692751857'),(23,'23uv117op215mn320rs59jh613kl%25wx%',NULL,NULL,NULL,NULL,NULL,'2022-08-02 06:28:36.000000','');
...
CREATE TABLE `adminuserinterface` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户接口权限';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `adminuserrole` (
  ...
  `uuid` bigint NOT NULL COMMENT '业务id',
...
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='登录信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-08-12 18:04:52
